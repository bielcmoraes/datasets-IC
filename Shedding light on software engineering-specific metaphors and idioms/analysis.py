...
df = pd.read_csv("C:/Users/gcmor/OneDrive/Área de Trabalho/datasets IC/Shedding light on software engineering-specific metaphors and idioms/github-train.csv")
